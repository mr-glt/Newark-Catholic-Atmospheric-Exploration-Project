...
this.browser = new Browser({ stock: false, hidden: false, channel: "", mode: "", name: "Firefox", version: new Version({ value: "40.0" }) });
this.engine = new Engine({ name: "Gecko", version: new Version({ value: "40.0" }) });
this.os = new Os({ name: "Windows", version: new Version({ value: "6.3", alias: "8.1" }) });
